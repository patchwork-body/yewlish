    ...
    html! {
        <Wrapper title="RadioGroup">
            ...
            <Section title="Default value">
                <RadioGroup default_value="2" on_value_change={Callback::from(move |value| {
                    log::info!("Value changed {value:?}");
                })} class={radio_group_class}>
                    <div class={radio_group_inner_class}>
                        <RadioGroupItem id="radio#4" name="radio" value="1" class={radio_group_item_class}>
                            <RadioGroupItemIndicator class={radio_group_item_indicator_class} />
                        </RadioGroupItem>

                        <label for="radio#4" class="text-neutral-200">{"Option 1"}</label>
                    </div>

                    <div class={radio_group_inner_class}>
                        <RadioGroupItem id="radio#5" name="radio" value="2" class={radio_group_item_class}>
                            <RadioGroupItemIndicator class={radio_group_item_indicator_class} />
                        </RadioGroupItem>

                        <label for="radio#5" class="text-neutral-200">{"Option 2"}</label>
                    </div>

                    <div class={radio_group_inner_class}>
                        <RadioGroupItem id="radio#6" name="radio" value="3" class={radio_group_item_class}>
                            <RadioGroupItemIndicator class={radio_group_item_indicator_class} />
                        </RadioGroupItem>

                        <label for="radio#6" class="text-neutral-200">{"Option 3"}</label>
                    </div>
                </RadioGroup>
            </Section>
        </Wrapper>
